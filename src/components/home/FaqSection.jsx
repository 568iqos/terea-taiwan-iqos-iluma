...
const faqs = [
  {
    q: "TEREA 是什麼產品？",
    a: "TEREA 是專為 IQOS ILUMA 系列設計的加熱式菸草彈，採用 Smartcore™ 感應加熱技術，從菸草內部加熱，溫度不超過 350°C，不產生燃燒、無灰燼。",
  },
  {
    q: "加熱不燃燒與傳統菸草有何不同？",
    a: "傳統菸草透過燃燒（600°C 以上）產生煙霧，而 TEREA 使用電磁感應將菸草加熱至 350°C 以下，產生蒸氣而非煙霧，因此無燃燒氣味，也不會產生灰燼。",
  },
  {
    q: "TEREA 有哪些口味可以選擇？",
    a: "目前 TEREA 台灣市場提供六款風味：醇原味、淡原味、柔原味、濃郁原味、綠洲珍珠（薄荷）、日光珍珠（柑橘薄荷），涵蓋菸草系與清涼系。",
  },
  {
    q: "在哪裡可以購買 TEREA？",
    a: "TEREA 可於全台授權門市購買，包含台北、台中、高雄等地。請前往「門市據點」頁面查詢最近的授權販售點。",
  },
  {
    q: "TEREA 每根可以使用多久？",
    a: "每根 TEREA 約可使用 14 口或 6 分鐘，具體時間依個人使用方式而異。",
  },
];
