...
const taiwanFlavors = [
  {
    ...
    gradient: "from-sky-300/10 to-blue-400/10",
    accentColor: "text-sky-700",
    bgAccent: "bg-sky-500",
    description: "台灣限定 TEREA 系列。清新薄荷搭配淡雅果香，霧感清涼如沐晨霧，順口而不刺激。",
    notes: ["清新薄荷", "淡雅果香", "霧感清涼"],
    intensity: 3,
    cooling: 4,
    region: "台灣",
  },
  {
    ...
    gradient: "from-indigo-300/10 to-indigo-500/10",
    accentColor: "text-indigo-700",
    bgAccent: "bg-indigo-500",
    description: "台灣限定 TEREA 系列。深邃薄荷與莓果交織，沁涼中帶有層次飽滿的果韻。",
    notes: ["深邃薄荷", "莓果香氣", "沁涼飽滿"],
    intensity: 3,
    cooling: 5,
    region: "台灣",
  },
  {
    ...
    gradient: "from-cyan-300/10 to-sky-500/10",
    accentColor: "text-cyan-700",
    bgAccent: "bg-cyan-500",
    description: "台灣限定 TEREA 系列。海洋般的清爽薄荷，入喉暢快透涼，餘韻乾淨俐落。",
    notes: ["清爽薄荷", "暢快透涼", "乾淨餘韻"],
    intensity: 2,
    cooling: 5,
    region: "台灣",
  },
  {
    ...
    gradient: "from-green-300/10 to-emerald-500/10",
    accentColor: "text-green-700",
    bgAccent: "bg-green-500",
    description: "台灣限定 TEREA 系列。青草與薄荷的清新組合，自然草本香氣溫和舒服。",
    notes: ["青草薄荷", "自然草本", "溫和舒服"],
    intensity: 2,
    cooling: 3,
    region: "台灣",
  },
  {
    ...
    description: "台灣限定 TEREA 系列。濃郁森林木質調搭配薄荷尾韻，沉穩而富有深度。",
    notes: ["森林木質", "薄荷尾韻", "沉穩深度"],
    intensity: 4,
    cooling: 3,
    region: "台灣",
  },
  {
    ...
    gradient: "from-purple-300/10 to-fuchsia-500/10",
    accentColor: "text-purple-700",
    bgAccent: "bg-purple-500",
    description: "台灣限定 TEREA 系列。莓果薄荷冰爽風味，甜中帶涼，香氣鮮明迷人。",
    notes: ["莓果薄荷", "甜涼冰爽", "香氣鮮明"],
    intensity: 3,
    cooling: 4,
    region: "台灣",
  },
  {
    ...
    gradient: "from-teal-200/10 to-cyan-400/10",
    accentColor: "text-teal-700",
    bgAccent: "bg-teal-400",
    description: "台灣限定 TEREA 系列。輕柔薄荷與淡茶香，清淡寧靜,適合喜愛溫和口感的你。",
    notes: ["輕柔薄荷", "淡雅茶香", "清淡寧靜"],
    intensity: 1,
    cooling: 3,
    region: "台灣",
  },
  {
    ...
    gradient: "from-slate-500/10 to-zinc-700/10",
    accentColor: "text-slate-800",
    bgAccent: "bg-slate-700",
    description: "台灣限定 TEREA 系列。濃烈菸草底韻結合強勁薄荷,黑冰般的冷冽強度,震撼有力。",
    notes: ["濃烈菸草", "強勁薄荷", "冷冽強度"],
    intensity: 5,
    cooling: 5,
    region: "台灣",
  },
